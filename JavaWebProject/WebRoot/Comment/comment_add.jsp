	...
	<form id="commentAddForm" enctype="multipart/form-data"  method="post">
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="comment_shuoshuoObj_shuoshuoId" name="comment.shuoshuoObj.shuoshuoId" style="width: auto"/>
			</span>
		</div>
		<div>
			<span class="label">评论内容:</span>
			<span class="inputControl">
				<textarea id="comment_commentContent" name="comment.commentContent" rows="6" cols="80"></textarea>
