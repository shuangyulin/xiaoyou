...
<div id="comment_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="commentQueryForm" method="post">
			被评说说：<input class="textbox" type="text" id="shuoshuoObj_shuoshuoId_query" name="shuoshuoObj.shuoshuoId" style="width: auto"/>
...
<div id="commentEditDiv">
	<form id="commentEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			<span class="label">被评说说:</span>
			<span class="inputControl">
				<input class="textbox"  id="comment_shuoshuoObj_shuoshuoId_edit" name="comment.shuoshuoObj.shuoshuoId" style="width: auto"/>
			</span>
		</div>
		<div>
			<span class="label">评论内容:</span>
			<span class="inputControl">
				<textarea id="comment_commentContent_edit" name="comment.commentContent" rows="8" cols="60"></textarea>
