$(function () {
	$("#comment_shuoshuoObj_shuoshuoId").combobox({
        ...
        onLoadSuccess: function () { //数据加载完毕事件
            var data = $("#comment_shuoshuoObj_shuoshuoId").combobox("getData"); 
            if (data.length > 0) {
                $("#comment_shuoshuoObj_shuoshuoId").combobox("select", data[0].shuoshuoId);
            }
        }
	});
