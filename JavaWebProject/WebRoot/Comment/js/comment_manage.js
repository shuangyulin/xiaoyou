				...
				$.ajax({
					...
					success : function (comment, response, status) {
						...
						if (comment) { 
							...
							$("#comment_shuoshuoObj_shuoshuoId_edit").combobox({
								url:"Shuoshuo/listAll",
							    valueField:"shuoshuoId",
							    textField:"shuoshuoContent",
							    panelHeight: "auto",
						        ...
						        onLoadSuccess: function () { //数据加载完毕事件
									$("#comment_shuoshuoObj_shuoshuoId_edit").combobox("select", comment.shuoshuoObjPri);
									//var data = $("#comment_shuoshuoObj_shuoshuoId_edit").combobox("getData"); 
						            //if (data.length > 0) {
						                //$("#comment_shuoshuoObj_shuoshuoId_edit").combobox("select", data[0].shuoshuoId);
						            //}
								}
							});
