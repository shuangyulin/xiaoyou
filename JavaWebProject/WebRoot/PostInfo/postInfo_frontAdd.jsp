...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-12 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>PostInfo/frontlist">文章管理</a></li>
		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
				  	 <label for="postInfo_title" class="col-md-2 text-right">文章标题:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="postInfo_title" name="postInfo.title" class="form-control" placeholder="请输入文章标题">
					 </div>
				  </div>
				  <div class="form-group">
				  	 <label for="postInfo_postPhoto" class="col-md-2 text-right">文章图片:</label>
				  	 <div class="col-md-8">
				  ...
				  <div class="form-group">
				  	 <label for="postInfo_content" class="col-md-2 text-right">文章内容:</label>
				  	 <div class="col-md-8">
				  ...
				  <div class="form-group">
				  	 <label for="postInfo_userObj_user_name" class="col-md-2 text-right">发布人:</label>
				  	 <div class="col-md-8">
				  ...
				  <div class="form-group">
				  	 <label for="postInfo_addTimeDiv" class="col-md-2 text-right">发布时间:</label>
				  	 <div class="col-md-8">
		                <div id="postInfo_addTimeDiv" class="input-group date postInfo_addTime col-md-12" data-link-field="postInfo_addTime">
		                    <input class="form-control" id="postInfo_addTime" name="postInfo.addTime" size="16" type="text" value="" placeholder="请选择发布时间" readonly>
		          ...
		          <style>#postInfoAddForm .form-group {margin:5px;}  </style>  
				</form> 
			</div>
...
<script>
//实例化编辑器
var postInfo_content_editor = UE.getEditor('postInfo_content'); //文章内容编辑器
