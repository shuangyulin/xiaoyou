		...
		<div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	<li role="presentation" ><a href="<%=basePath %>Reply/frontlist">文章回复列表</a></li>
			    	<li role="presentation" class="active"><a href="#replyAdd" aria-controls="replyAdd" role="tab" data-toggle="tab">添加文章回复</a></li>
				</ul>
				<!-- Tab panes -->
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="replyAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="reply_postInfoObj_postInfoId" class="col-md-2 text-right">被回文章:</label>
						  	 <div class="col-md-8">
